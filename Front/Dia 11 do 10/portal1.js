function mostrarTopico(frase, frase2, numero){
    ...
    var logado = "Sim"
      //document.getElementById("LoginFeito").value
    var add = "ADD"

    if(verificarN === 1 && logado === "Sim"){            
        div.innerHTML = "<a href='enviarArtigos.html' target='_blank' id='fraseForum'>" + "<button style='margin-left: 180px; color: blue; cursor: pointer; border-radius: 8px; position: absolute; text-decoration: none; '>" + add + "</button>" + "</a>" + "<h1>" + "<a href='exemplo1.html' target='_blank' id='fraseForum'>" + text + "</a>" + "</h1>" + "<h1>" + "<a href='exemplo2.html' target='_blank' id='fraseForum'>" + text2 + "</a>" + "</h1>" + "<br>"
    } else {
        if(verificarN === 1){
