...
<!--input value="Sim" type="text" hidden="hidden" id="LoginFeito" />-->
     <?php
        session_start();
        include("tratamentoCadastro.php");
        ...
        if(isset($_SESSION['id'])){
            if($_SESSION['adm']){
                echo '<input value="Sim" type="text" hidden="hidden" id="Administrador" />';
            }else{
                echo '<input value="Nao" type="text" hidden="hidden" id="Administrador" />';
            }
        }
        ?> 
    <header id="cabecalho"> 
    ...
    <h2 style="margin-left: 180px; color: black;">Barra de navegacão</h2>
    <ul>
    ...
    <div class="form-popup" id="myForm">
        <form id="login-usuario-form" class="form-container">
